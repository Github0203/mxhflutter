...
class pageFriendRequired extends StatefulWidget {
  //    final bottombarC? data; 
  // HomePage({required this.data}); 
  @override
  _pageFriendRequiredState createState() => _pageFriendRequiredState();
}

class _pageFriendRequiredState extends State<pageFriendRequired> {
    ...
    children: <Widget>[
      ...
      Positioned(
        ...
        body: _page == 0 ? const feedHome() :
              ...
              _page == 5 ? const friendPageRequireC() : Container(),
        );
  }
}
