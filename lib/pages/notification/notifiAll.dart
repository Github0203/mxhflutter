...
class notifiAll extends StatefulWidget {   
  const notifiAll({super.key});

  @override
  State<notifiAll> createState() => _notifiAllState();
}
...
class _notifiAllState extends State<notifiAll> {
  bool chuadoc = false;
  bool dadochet = false;
  @override
