...
import 'package:mangxahoi/pages/watch/videoitems/pages/auto_fullscreen_orientation_page.dart';
import 'package:mangxahoi/pages/watch/videoitems/pages/basic_player_page.dart';
import 'package:mangxahoi/pages/watch/videoitems/pages/cache_page.dart';
import 'package:mangxahoi/pages/watch/videoitems/pages/clearkey_page.dart';
import 'package:mangxahoi/pages/watch/videoitems/pages/controller_controls_page.dart';
import 'package:mangxahoi/pages/watch/videoitems/pages/controls_always_visible_page.dart';
import 'package:mangxahoi/pages/watch/videoitems/pages/controls_configuration_page.dart';
import 'package:mangxahoi/pages/watch/videoitems/pages/custom_controls/change_player_theme_page.dart';
import 'package:mangxahoi/pages/watch/videoitems/pages/dash_page.dart';
import 'package:mangxahoi/pages/watch/videoitems/pages/drm_page.dart';
import 'package:mangxahoi/pages/watch/videoitems/pages/event_listener_page.dart';
import 'package:mangxahoi/pages/watch/videoitems/pages/fade_placeholder_page.dart';
import 'package:mangxahoi/pages/watch/videoitems/pages/hls_audio_page.dart';
import 'package:mangxahoi/pages/watch/videoitems/pages/hls_subtitles_page.dart';
import 'package:mangxahoi/pages/watch/videoitems/pages/hls_tracks_page.dart';
import 'package:mangxahoi/pages/watch/videoitems/pages/memory_player_page.dart';
import 'package:mangxahoi/pages/watch/videoitems/pages/normal_player_page.dart';
import 'package:mangxahoi/pages/watch/videoitems/pages/notification_player_page.dart';
import 'package:mangxahoi/pages/watch/videoitems/pages/overridden_aspect_ratio_page.dart';
import 'package:mangxahoi/pages/watch/videoitems/pages/overriden_duration_page.dart';
import 'package:mangxahoi/pages/watch/videoitems/pages/placeholder_until_play_page.dart';
import 'package:mangxahoi/pages/watch/videoitems/pages/playlist_page.dart';
import 'package:mangxahoi/pages/watch/videoitems/pages/resolutions_page.dart';
import 'package:mangxahoi/pages/watch/videoitems/pages/reusable_video_list/reusable_video_list_page.dart';
import 'package:mangxahoi/pages/watch/videoitems/pages/rotation_and_fit_page.dart';
import 'package:mangxahoi/pages/watch/videoitems/pages/subtitles_page.dart';
import 'package:mangxahoi/pages/watch/videoitems/pages/video_list/video_list_page.dart';
