...
import 'package:mangxahoi/thuvien/src/core/app_constant.dart';
import 'package:mangxahoi/thuvien/src/model/gallery.dart';
import 'package:mangxahoi/thuvien/src/widgets/gallery_thumbnail.dart';
...
class GalleryStaggeredGridView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return StaggeredGridView.countBuilder(
      ...
      itemCount: galleryLength > AppConstant.NUM_IMAGE_COLLAPSE ? AppConstant.NUM_IMAGE_COLLAPSE : galleryLength,
      itemBuilder: (context, int index) {
        return SizedBox(
          height: 252,
          child: galleryLength > AppConstant.NUM_IMAGE_COLLAPSE && index == 3
              ? GalleryRemainder(
                  remainNumber: galleryLength - AppConstant.NUM_IMAGE_COLLAPSE + 1,
                  indexOfImage: index,
